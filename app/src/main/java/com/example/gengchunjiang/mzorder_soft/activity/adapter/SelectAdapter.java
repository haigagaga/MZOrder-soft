...
import com.example.gengchunjiang.mzorder_soft.activity.entity.GoodsItem;
import com.example.gengchunjiang.mzorder_soft.activity.activity.ShoppingCartActivity;
...
public class SelectAdapter extends RecyclerView.Adapter<SelectAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_cart_selected_goods, parent, false);
